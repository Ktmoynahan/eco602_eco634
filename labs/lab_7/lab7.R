...
Gent_sd = sd(!is.na(dat_pen2$bill_length_mm))
print(Gent_sd)
...
# 2: Calculate sample standard error
sse = sd(!is.na(dat_pen2$bill_length_mm, na.rm = TRUE) / sqrt(n))
print(sse)
...
print(myboot)
str(myboot)
gent_mean = mean(!is.na(dat_pen2$bill_length_mm))
print(gent_mean)
myboot$t0
mean(myboot$t) - myboot$t0
sd(myboot$t)
...
matplot(
  ...
  main="Keegan's Awesome Rarefaction Curve")
